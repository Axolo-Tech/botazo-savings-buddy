  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="gradient-botazo px-5 pt-6 pb-8 rounded-b-3xl">
        <h1 className="text-primary-foreground font-extrabold text-lg mb-4">Wallet de Recompensas</h1>
        <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-5 flex items-center gap-4">
          ...
          <div>
            <p className="text-primary-foreground/70 text-xs font-semibold">Saldo total</p>
      ...
      <div className="px-5 mt-5">
        <h2 className="text-base font-extrabold text-foreground mb-3">Historial</h2>
        <div className="space-y-2.5">
          {transactions.map((tx, i) => (
            <motion.div
              ...
              className="bg-card rounded-xl p-3.5 flex items-center gap-3 shadow-sm border border-border"
            >
              <div
